...
open class RessortRecord private constructor() : UpdatableRecordImpl<RessortRecord>(RessortTable.RESSORT), Record3<String?, String?, String?> {
    ...
    override fun field1(): Field<String?> = RessortTable.RESSORT.ID
    ...
    override fun value1(value: String?): RessortRecord {
        set(0, value)
        return this
    }
    ...
    override fun values(value1: String?, value2: String?, value3: String?): RessortRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        return this
     ...
     */
    constructor(id: String, name: String, description: String? = null): this() {
        this.id = id
        this.name = name
