...
open class V7Backend : SchemaImpl("v7_backend", DefaultCatalog.DEFAULT_CATALOG) {
    public companion object {

        /**
         * The reference instance of <code>v7_backend</code>
         */
        val V7_BACKEND: V7Backend = V7Backend()
    }
