...
open class UserDao(configuration: Configuration?) : DAOImpl<UserRecord, User, String>(UserTable.USER, User::class.java, configuration) {
    ...
    override fun getId(o: User): String = o.id

    /**
     * Fetch records that have <code>id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfId(lowerInclusive: String, upperInclusive: String): List<User> = fetchRange(UserTable.USER.ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>id IN (values)</code>
     */
    fun fetchById(vararg values: String): List<User> = fetch(UserTable.USER.ID, *values)

    /**
     * Fetch a unique record that has <code>id = value</code>
     */
    fun fetchOneById(value: String): User? = fetchOne(UserTable.USER.ID, value)
     ...
     * upperInclusive</code>
     */
    fun fetchRangeOfUserRole(lowerInclusive: String, upperInclusive: String): List<User> = fetchRange(UserTable.USER.USER_ROLE, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>user_role IN (values)</code>
     */
    fun fetchByUserRole(vararg values: String): List<User> = fetch(UserTable.USER.USER_ROLE, *values)
