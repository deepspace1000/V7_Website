...
open class RessortDao(configuration: Configuration?) : DAOImpl<RessortRecord, Ressort, String>(RessortTable.RESSORT, Ressort::class.java, configuration) {
    ...
    override fun getId(o: Ressort): String = o.id

    /**
     * Fetch records that have <code>id BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    fun fetchRangeOfId(lowerInclusive: String, upperInclusive: String): List<Ressort> = fetchRange(RessortTable.RESSORT.ID, lowerInclusive, upperInclusive)

    /**
     * Fetch records that have <code>id IN (values)</code>
     */
    fun fetchById(vararg values: String): List<Ressort> = fetch(RessortTable.RESSORT.ID, *values)

    /**
     * Fetch a unique record that has <code>id = value</code>
     */
    fun fetchOneById(value: String): Ressort? = fetchOne(RessortTable.RESSORT.ID, value)
